...
1. 需求属性：生理需求、安全需求、精神需求与价值需求；

2. 经济属性：以货币为单元的所有关系、各类别的财产所有关系；

3. 社会属性：家庭关系、工作关系、社群关系。

<td>

- 区块链账户实现对人的身份定位和描述；

- 以账户与智能合约的关系实现人的社会关系描述；

- 基于人的账户、经济关系、社会关系的各类应用系统描述人的需求属性及实现。
...
3. 执行属性：在智能化条件下受控于所有者的命令。

<td>

- 区块链中通过物联网实现与物质实体的绑定，通过对物质实体所有权与账户绑定实现归属权的映射；

- 通过智能合约定义物质实体的功能属性；

- 通过所有者向物质实体智能合约发送命令交易，实现物质实体的功能控制映射。
...
1. 自然人：各类拥有经济关系和社会关系的自然人构成社会的基本单元；

2. 法人组织：各类私有、公立、行业法人主体构成社会组织单元；

3. 物理空间：现实世界的物理空间、物质流通场景。
