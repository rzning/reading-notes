...
<tr>
    ...
    <td>
        <ul>
            ...
            <li>基于人的账户、经济关系、社会关系的各类应用系统描述人的需求属性及实现。</tr>
<tr>
    <th>物
    <td>物质实体的构成要件包括以下三点：
        <ol>
    ...
    <td>
        <ul>
            ...
            <li>通过所有者向物质实体智能合约发送命令交易，实现物质实体的功能控制映射。</tr>
<tr>
    <th>经济
...
<tr>
    ...
    <td>通过智能合约描述实现现实经济组织、社会组织的决策流程、行政流程与业务流程在区块链的映射。</tr>
<tr>
    <th>社会
    <td>社会构成要件有如下三点：
        <ol>
    ...
    <td>以分布式 P2P 网络为基础，实现各类现实物质实体、自然人、经济组织、社会组织基于区块链物联网、账户、智能合约在区块链上的映射，以及各类活动关系的频繁交易、互动，构成基于互联网络的、可信的区块链虚拟社会活动关系和生态系统。</tr></table>
